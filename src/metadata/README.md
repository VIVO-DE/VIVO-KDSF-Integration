 ...
 * [KDSF-VIVO-Integration.yml](KDSF-VIVO-Integration.yml)
     * Determines how your purl.obolibrary.org/obo/KDSF-VIVO-Integration/ redirects will be handled
     ...
     * Paste in the contents of [KDSF-VIVO-Integration.yml](KDSF-VIVO-Integration.yml)
 ...
 * [KDSF-VIVO-Integration.md](KDSF-VIVO-Integration.md)
     ...
     * Paste in the contents of [KDSF-VIVO-Integration.md](KDSF-VIVO-Integration.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
